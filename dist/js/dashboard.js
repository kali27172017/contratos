...
var btnRegister = document.getElementById("register_submit");

var formRegisterTeacher = function formRegisterTeacher(e) {
  e.preventDefault();
  var inputs = document.fregister.elements;
  //validate(inputs)
  var dataRegister = [];
...
var formRegisterRequestAjax = function formRegisterRequestAjax(dataRegister) {
  $.ajax({
    type: "POST",
...
var changeTextBtn = function changeTextBtn(bandera) {
  if (bandera == "correcto") {
